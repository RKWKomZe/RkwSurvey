...
return [
	'ctrl' => [
		...
		*/
		...
		'searchFields' => 'required,group_by,topic,question,hint,short_name,type,text_consent,text_rejection,scale_from_points,scale_to_points,scale_step,answer_option,benchmark,benchmark_value,benchmark_label,benchmark_weighting, survey,do_action,do_action_if,do_action_jump',
	...
	'types' => [
		...
		'1' => ['showitem' => 'hidden, required, group_by, topic, question, hint, short_name, type, text_consent, text_rejection, scale_from_points, scale_to_points, scale_step, answer_option, benchmark, benchmark_label, benchmark_value, benchmark_weighting, scale_open_from, scale_open_to, scale_open_step,  do_action, do_action_if, do_action_jump, survey, --div--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:tabs.access, starttime, endtime'],
    ],
	'columns' => [
	    /*
		'sys_language_uid' => [
...
//            'displayCond' => 'FIELD:benchmark:=:1',
        ...
        'topic' => [
            'exclude' => 0,
            'label' => 'LLL:EXT:rkw_survey/Resources/Private/Language/locallang_db.xlf:tx_rkwsurvey_domain_model_question.topic',
            'config' => [
                'type' => 'select',
                'renderType' => 'selectSingle',
                'size' => 1,
                'eval' => 'int',
                'items' => [
                    ['LLL:EXT:rkw_survey/Resources/Private/Language/locallang_db.xlf:tx_rkwsurvey_domain_model_question.please_choose',0],
                ],
                'minitems' => 0,
                'maxitems' => 1,
                'default' => '',
        ...
        'benchmark_label' => [
            'exclude' => false,
            'label' => 'LLL:EXT:rkw_survey/Resources/Private/Language/locallang_db.xlf:tx_rkwsurvey_domain_model_question.benchmark.label',
            'config' => [
                'type' => 'input',
                'eval' => 'trim'
            ],
        ...
        'benchmark_weighting' => [
            'exclude' => false,
            'label' => 'LLL:EXT:rkw_survey/Resources/Private/Language/locallang_db.xlf:tx_rkwsurvey_domain_model_question.benchmark.weighting.values',
            'config' => [
                'type' => 'input',
                'size' => 50,
                'eval' => 'trim, required'
        ...
        'scale_from_points' => [
            'exclude' => false,
            'label' => 'LLL:EXT:rkw_survey/Resources/Private/Language/locallang_db.xlf:tx_rkwsurvey_domain_model_question.scale_from_points',
            'config' => [
                'type' => 'input',
                'size' => 10,
                'eval' => 'trim'
...
//		],
        ...
        'scale_step' => [
            'exclude' => false,
            'label' => 'LLL:EXT:rkw_survey/Resources/Private/Language/locallang_db.xlf:tx_rkwsurvey_domain_model_question.scale_step',
            'config' => [
                'type' => 'input',
                'size' => 10,
                'eval' => 'trim'
