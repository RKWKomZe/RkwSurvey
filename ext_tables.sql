...
#
# Table structure for table 'tx_rkwsurvey_domain_model_questioncontainer'
#
CREATE TABLE tx_rkwsurvey_domain_model_questioncontainer (

	uid int(11) NOT NULL auto_increment,
	pid int(11) DEFAULT '0' NOT NULL,

	name varchar(255) DEFAULT '' NOT NULL,
	hide_name_fe int(11) DEFAULT '0' NOT NULL,
